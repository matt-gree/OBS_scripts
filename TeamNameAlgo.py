char_class_dict = {
        ...
        'Dry Bones(Gy)': {'Class': 'Balance', 'Simplified Name': 'Dry Bones'},
        'Dry Bones(G)': {'Class': 'Balance', 'Simplified Name': 'Dry Bones'},
        'Dry Bones(R)': {'Class': 'Balance', 'Simplified Name': 'Dry Bones'},
        'Dry Bones(B)': {'Class': 'Balance', 'Simplified Name': 'Dry Bones'},
