...
class rosterimages:
    ...
    def get_team_rosters_from_RW(self, game_key):
        ...
        for i in range(9):
            ...
            self.roster_image_list[i][2] = Lookup.lookup(LookupDicts.CHAR_NAME, (selected_game[char_string]).replace(' (', '()'))
        ...
        for i in range(9):
            ...
            self.roster_image_list[i+9][2] = Lookup.lookup(LookupDicts.CHAR_NAME, selected_game[char_string]).replace(' (', '()')
